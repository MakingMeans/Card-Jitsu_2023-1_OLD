	...
	private static class InterfazInicialPanel extends JPanel {
		...
		public InterfazInicialPanel() {
			iVenIniSes = new ImageIcon(
					getClass().getResource("/co/edu/unbosque/assets/imagenesInterfaz/VentanaIS.png"));
		}
