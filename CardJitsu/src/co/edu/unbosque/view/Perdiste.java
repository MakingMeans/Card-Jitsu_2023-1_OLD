...
public class Perdiste extends JFrame{
	...
	public Perdiste() {
		...
		InterfazLose panel = new InterfazLose();
	...
	private static class InterfazLose extends JPanel {
		private static final long serialVersionUID = 1L;
		private ImageIcon iCuenta;

		public InterfazLose() {
			iCuenta = new ImageIcon(getClass().getResource("/co/edu/unbosque/assets/imagenesInterfaz/PinguinoTroste.png"));
		}
